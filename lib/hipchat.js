...
module.exports = function (addon) {
        ...
        return new RSVP.Promise(function (resolve, reject) {
            ...
            function makeRequest(clientInfo) {
                addon.getAccessToken(clientInfo).then(function (token) {
                    ...
                    // console.log('outgoing http req: ', httpReq);

                    http(httpReq, function (err, resp, body) {
                        if (err) {
                            reject(err);
                            return;
                        }
    ...
    return {
        ...
        getLatestHistory: function (clientInfo, roomId, maxResults) {
            var options = {
                method: 'GET',
            ...
            return request(clientInfo, options);
        },

        createIntegrationLink: function(clientInfo, target, ttl) {
            return request(clientInfo, {
                method: "POST",
                resource: '/addon/link',
                body: {
        ...
        deleteIntegrationLink: function(clientInfo, linkToken) {
            return request(clientInfo, {
                method: "DELETE",
                resource: '/addon/link/' + linkToken
            })
        }
